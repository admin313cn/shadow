...
//            toolbar.setNavigationIcon( mDrawable);//或者在布局中 app:navigationIcon="?attr/homeAsUpIndicator"
    ...
    protected void setStatusBar() {
        cn.u313.plugin.comm.nav.StatusBarUtil.setRootViewFitsSystemWindows(this, true);
        //设置状态栏透明
        cn.u313.plugin.comm.nav.StatusBarUtil.setTranslucentStatus(this);
        //一般的手机的状态栏文字和图标都是白色的, 可如果你的应用也是纯白色的, 或导致状态栏文字看不清
        //所以如果你是这种情况,请使用以下代码, 设置状态使用深色文字图标风格, 否则你可以选择性注释掉这个if内容
        if (!cn.u313.plugin.comm.nav.StatusBarUtil.setStatusBarDarkTheme(this, true)) {
